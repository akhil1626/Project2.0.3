...
<%	try
	{
		...
		ResultSet rs2=st2.executeQuery("select im.itemid,im.catid,im.itemname,im.startprice,im.enddate,im.seller,bi.bidderid,bi.bamt from item_master im,bidding_info bi where im.enddate<= curdate() and im.seller='"+request.getParameter("theuser")+"' and bi.status=2 and im.itemid=bi.itemid");
