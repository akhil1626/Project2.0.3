...
<%	try
	{
		...
		if(rs.next())
		{
			...
			else 
			{
				...
				if(i>0)
				{
		ResultSet rs2=st2.executeQuery("select im.itemid,im.catid,im.itemname,im.startprice,im.enddate,im.seller,bi.bidderid,bi.bamt,cm.cat_name from item_master im,bidding_info bi,category_master cm where im.enddate<= curdate() and cm.catid=im.catid and bi.bidderid='"+bidder+"' and bi.status=2 and bi.itemid="+id);
