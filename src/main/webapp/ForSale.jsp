...
<center>
      <%
	    ...
	    ResultSet rs2=st.executeQuery("select im.itemid,im.catid,im.itemname,im.startprice,im.enddate,im.seller,bi.bidderid,bi.bamt from item_master im,bidding_info bi where im.enddate>= CURDATE() and bi.status=1 and im.itemid=bi.itemid order by itemid");
