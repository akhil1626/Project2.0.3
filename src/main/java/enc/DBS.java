   ...
   public  DBS(int op,String x)
	...
	String toBeSaved = "";
	   ...
	   int  choice=op;
		...
		String key = "card";//JOptionPane.showInputDialog("Enter your key (the longer the better):");
		...
		JOptionPane.showMessageDialog(null,"\nYour Credit card Number has been encrypted \n"+new String(encryption.getFileBytes())+"\n","message",JOptionPane.INFORMATION_MESSAGE);
		}
