         		...
         		if (session == null ) 
		{
			...
			if(bol==true)
			{
				...
				if(password.equals(pwd))
				{
					...
					String squery = "insert into item_master values("+titemid+","+catid+",'"+itemname+"','"+desc+"','"+summary+"',"+startprice+","+incrprice+",DATE_FORMAT(CURDATE(),'%Y-%m-%d'),DATE_FORMAT(CURDATE()+"+acDays+",'%Y-%m-%d'),'"+seller+"',0) ";
