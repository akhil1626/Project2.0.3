...
pw.println("<BODY bgColor=#a3d881 leftMargin=0 topMargin=0 MARGINHEIGHT=0 MARGINWIDTH=0><!-- ImageReady Slices (Untitled-1) -->");
		...
		pw.println("<form method='POST' action='./AdminLogin1'>");
		pw.println("<center><h2>Administartor<h2><br>");
		pw.println("<table><tr><td>Admin User: </td><td><input type=text name=usr ></td></tr>");
		pw.println("<tr><td>password: </td><td><input type=password name=password ></td></tr>");
		pw.println("</table><br>");
		pw.println("<center><input type=submit value='Sign Up' > </form>");
